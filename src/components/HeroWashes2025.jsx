        ...
        <>
            <section id="heroQuemSomos" className="container mx-auto flex flex-col mt-8 mb-8 lg:my-24 lg:flex-row px-5">
                <div className="flex flex-col items-center lg:flex-row gap-7">
                    ...
                    <h1 className="text-[28px] lg:text-[32px] font-semibold text-[#0D6080]">WASHES 2025</h1>
                    <p className="text-lg font-light text-[#2F2F2F] lg:text-[26px] leading-9 lg:text-justify">
                        O WASHES 2025 será realizado no formato presencial nos dias 22 e 23 de julho de 2025 (datas sujeitas à mudanças), como um evento satélite do <strong className="font-bold">45o. Congresso da Sociedade Brasileira de Computação (SBC)</strong>, que será realizado entre 20 e 24 de julho de 2025.
                        </p>
                        <Link
                            to="/quem-somos"
                        ...
                        >
                            Saiba mais sobre o WASHES 2025!
                        </Link>
                    </div>
                </div>
            </section>
